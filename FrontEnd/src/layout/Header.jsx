    ...
    <header className="site-header">
      ...
      <div className="header-container">
        ...
        <div className="header-actions">
          <div
            className={`search-inline-wrapper ${
              searchOpen ? "open" : ""
            }`}
            ref={searchRef}
          >
            {!searchOpen ? (
              ...
              >
                ...
                <button
                  type="submit"
                  className="search-inline-submit"
                  aria-label="Search"
                >
                  <svg
                    width="16"
          ...
          <Link
            to="/cart"
            className="action-item cart-link"
            aria-label="Cart"
          >
          ...
          {(!role || role?.toUpperCase() === "USER") && (
            <div
              className="action-item dropdown-wrapper"
              ref={wishlistRef}
            >
              <button
          ...
          {isLoggedIn && role?.toUpperCase() !== "ADMIN" ? (
            <div
              className="action-item dropdown-wrapper user-menu-wrapper"
              ref={userMenuRef}
            >
              <button
